...
import (
	...
	"github.com/youryharchenko/go-json-rest/rest"
	"github.com/youryharchenko/go-json-rest/rest/test"
	"github.com/youryharchenko/jwt-go"
)
...
func TestAuthJWT(t *testing.T) {
	...
	claimsNoId := tokenNoId.Claims.(jwt.MapClaims)
	...
	claimsBadSigning := tokenBadSigning.Claims.(jwt.MapClaims)
	...
	if newTokenClaims["id"].(string) != "admin" || int64(newTokenClaims["exp"].(float64)) < before {
