...
// -----------------------------------------------------------------------------
const goappEnv = {"GOAPP_ROOT_PREFIX":"/gomoku/","GOAPP_STATIC_RESOURCES_URL":"/gomoku/static/","GOAPP_VERSION":"916fdea053322b4da9a40d66c08153f7dccba8c9"};
...
if (!/bot|googlebot|crawler|spider|robot|crawling/i.test(navigator.userAgent)) {
  ...
  WebAssembly.instantiateStreaming(fetch("/gomoku/web/app.wasm"), go.importObject)
    .then(result => {
